...
import DetailInnerSeedsFarm from './DetailInnerSeedsFarm'

const InnerSeedsFarm = () => {
   ...
   useEffect(() => {
      dispatch(getOneData({ category: 'agroGrainGrowing', id }))
   }, [])
   ...
   return (
      <TempleteInnerPage pathsArray={pathsArray}>
         ...
         {!isLoading && <DetailInnerSeedsFarm oneData={oneData} />}
      </TempleteInnerPage>
   )
}

export default InnerSeedsFarm
