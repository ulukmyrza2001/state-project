...
import DetailInnerAgroAdvices from './DetailInnerAgroAdvices'

const InnerAgroAdvices = () => {
   ...
   useEffect(() => {
      dispatch(getOneData({ category: 'agroAdvice', id }))
   }, [])
   ...
   return (
      <TempleteInnerPage pathsArray={pathsArray}>
         ...
         {!isLoading && <DetailInnerAgroAdvices oneData={oneData} />}
      </TempleteInnerPage>
   )
}

export default InnerAgroAdvices
