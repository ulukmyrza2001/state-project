      ...
      <Container>
         <WrapperLeftContent>
            <WrapperText
               ...
               direction="column"
            >
               <h3>Демилге жонундо маалымат</h3>
               <Text>{parse(String(oneData?.info))}</Text>
            </WrapperText>
            <Flex direction="column" margin="20px 0 0 0" gap="6px">
               <p>
                  <b>Демилгенин аталышы:</b> {oneData?.initiativesName}
               </p>
               <p>
                  <b>Аты-жону:</b> {oneData?.initiativesDirectorName}
               </p>
               <p>
...
export default DetailInitiaves
